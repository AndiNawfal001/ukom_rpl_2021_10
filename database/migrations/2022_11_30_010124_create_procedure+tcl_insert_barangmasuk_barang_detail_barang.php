    ...
    DB::unprepared(
        ...
        IF (cek_barang_masuk = 0) THEN
            ...
            IF(jml_barang < jumlah_pengajuan) THEN
                INSERT INTO barang_masuk (id_pengajuan, supplier, manajemen, nama_barang, jml_masuk, tgl_masuk, status_pembelian)
                VALUES (pengajuan, id_supplier, nip, nama_barang, jml_barang, NOW(), 'outstanding');
            ...
            ELSEIF(jml_barang = jumlah_pengajuan) THEN
                ...
                INSERT INTO barang_masuk (id_pengajuan, supplier, manajemen, nama_barang, jml_masuk, tgl_masuk, status_pembelian)
                VALUES (pengajuan, id_supplier, nip, nama_barang, jml_barang, NOW(), 'selesai');
