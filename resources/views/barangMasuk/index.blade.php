...
<div class="pt-6 px-4">
    <div class="grid grid-cols-1 2xl:grid-cols-2 gap-4">
        <div class="lg:flex gap-5">
            ...
            <div class="bg-base-100 shadow rounded-lg p-4 sm:p-6 mt-4 lg:mt-0 basis-2/5 border-t-2 border-primary">
                <div class="lg:flex justify-between mb-2">
                    <h1 class="text-xl pb-3 font-semibold leading-loose">Jenis Barang</h1>
                    <div class="flex flex-row-reverse">
                        <label for="tambahjenisBarang" class="btn btn-success btn-sm gap-2">
                ...
                <div class="overflow-x-auto  mb-4">
                    ...
                    <div class="lg:flex flex-row-reverse">
                        <div>
                                {{-- {{ $approved->links('jenisBarang') }} --}}
                                {{-- {{$jenisBarang->appends(['jenisBarang' => $jenisBarang->currentPage()])->links()}} --}}
                            </div>
                        </div>
                </div>
            </div>
        ...
        <label class="modal-box relative" for="">
            <form action="/jenisBarang/tambah" method="POST">
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="nama_jenis" class="input input-bordered" required/>
                </div>
