...
<div class="shadow-md rounded-md mx-auto  bg-base-100 p-5">
    <form action="/ruangan/editsimpan" method="POST">
        ...
        <div class="flex justify-between">
            <h1 class="h1-judul">Edit Ruangan</h1>
            <div class="">
        ...
        <input type="hidden" name="id_ruangan" class="input input-sm input-bordered"  value="{{ $edit->id_ruangan }}" required/>

           <div class="form-control">
               <label class="label">
               <span class="label-text">Nama Ruangan</span>
               </label>
               <input type="text" name="nama_ruangan" class="input input-sm input-bordered @error('nama_ruangan') input-error @enderror"
           ...
           <div class="form-control">
               ...
               <input type="text" name="penanggung_jawab" class="input input-sm input-bordered"
