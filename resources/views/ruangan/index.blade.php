...
<div class="pt-6 px-4">
    <div class="bg-base-100 shadow rounded-md p-4 sm:p-5 ">
        <h1 class="h1-judul">Daftar Ruangan</h1> 
                ...
                <table class="table-primary">
                    <thead class="bg-base-200">
                        <tr>
                            ...
                            <x-table-header>Nama Ruangan</x-table-header>
                            <x-table-header>Penanggung Jawab</x-table-header>
                            <x-table-header>Ket</x-table-header>
                    ...
                    <tr>
                        ...
                        <td class="border-table">{{ $item->nama_ruangan }}</td>
                        <td class="border-table">{{ $item->penanggung_jawab }}</td>
                        <td class="border-table">{{ $item->ket }}</td>
                        <td class="border-table text-center">
                            <a href="/ruangan/edit/{{ $item->id_ruangan }}">
                                <button class="btn btn-sm btn-warning btn-square btn-outline">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                </button>
                            </a>
                            <label for="delete{{ $item->id_ruangan }}" class="btn btn-sm btn-error btn-square btn-outline">
