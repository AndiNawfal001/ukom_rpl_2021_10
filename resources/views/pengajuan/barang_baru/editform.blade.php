 ...
 <div class="shadow-md rounded-md mx-auto  bg-base-100 p-5">
    <form action="/pengajuan/BB/update/{{$edit->id_pengajuan_bb}}" method="POST">
        ...
        <div class="flex justify-between">
            <h2 class="h1-judul">Edit Pengajuan</h2>
            <div class="">
        ...
        <div class="lg:flex flex-row gap-5">
            <div class="basis-1/2">
                <div class="form-control">
                    ...
                    <input type="text" name="nama_barang" class="input input-sm input-bordered @error('nama_barang') input-error @enderror"
            ...
            <div class="basis-1/2">
                <div class="form-control">
                    ...
                    <input type="number" name="harga_satuan" class="input input-sm input-bordered"
                ...
                <div class="form-control">
                    ...
                    <input type="number" name="jumlah" class="input input-sm input-bordered"
