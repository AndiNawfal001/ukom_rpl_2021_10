 ...
 <div class="shadow-xl rounded-2xl mx-auto  bg-base-100 p-5">
    <form action="/pengajuan/BB/simpan" method="POST">
        ...
        <div class="flex justify-between">
            <h2 class="text-xl font-semibold">Tambah Pengajuan</h2>
            <div class="">
        ...
        <div class="lg:flex flex-row gap-5">
            <div class="basis-1/2">
                <div class="form-control">
                    ...
                    <input type="text" name="nama_barang" class="input input-bordered @error('nama_barang') input-error @enderror" value="{{ old('nama_barang') }}" required autocomplete="off"/>
                    @error('nama_barang')
