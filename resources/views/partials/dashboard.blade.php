...
<div class="pt-6 px-4">
    <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4">
        <div class="bg-base-100 shadow rounded-lg p-4 sm:p-6 xl:p-8  2xl:col-span-2">
    ...
    <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4 mt-4">
        ...
        @can('admin')
            <div class="bg-gradient-to-r from-base-100 to-red-500 shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                <div class="mb-4 flex items-center justify-between">
                    <div>
        ...
        @can('manajemen')
            <div class="bg-gradient-to-r from-base-100 to-green-500 shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                <div class="mb-4 flex items-center justify-between">
                    <div>
        ...
        @can('kaprog')
            <div class="bg-gradient-to-r from-base-100 to-blue-500 shadow rounded-lg p-4 sm:p-6 xl:p-8 ">
                <div class="mb-4 flex items-center justify-between">
                    <div>
