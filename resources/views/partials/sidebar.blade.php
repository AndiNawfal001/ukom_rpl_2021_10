<div class="relative flex-1 flex flex-col min-h-0 shadow bg-base-100 bg-opacity-80 pt-0">
    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
       <div class="flex-1 px-3 divide-y space-y-1">
        <ul class="space-y-2">
            <li class="transition hover:bg-base-200 border-primary rounded-sm group {{ request()->is('dashboard') ? 'bg-base-300 border-r-2' : '' }}">
            ...
            @can('admin')
                <li class="transition hover:bg-base-200 border-primary rounded-sm group {{ request()->is('log*') ? 'bg-base-300 border-r-2' : '' }}">
            ...
            @can('admin+manajemen')
                <li class="transition hover:bg-base-200 border-primary rounded-sm group {{ request()->is('barangMasuk*') ? 'bg-base-300 border-r-2' : '' }}">
            ...
            <li class="transition group">
                <button type="button" class="swap flex items-center p-2 w-full text-base font-normal rounded-sm hover:bg-base-200 dropdown-btn" >
                    <svg class="w-6 h-6 text-gray-500 group-hover:text-base-content" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                ...
                <ul class="py-2 space-y-2 dropdown-container {{ request()->is('pengajuan/BB*', 'pengajuan/PB*' ,'pemutihan*') ? 'block' : 'hidden' }}">
                    <li>
                        <a href="/pengajuan/BB" class="flex items-center p-2 pl-11 w-full text-base border-primary font-normal rounded-sm transition duration-75 group hover:bg-base-200 {{ request()->is('pengajuan/BB*') ? 'bg-base-300 border-r-2' : '' }}">Barang Baru</a>
                    </li>
                    <li>
            ...
            <li class="transition hover:bg-base-200 border-primary rounded-sm group {{ request()->is('barang', 'barang/detail*', 'barang/search*') ? 'bg-base-300 border-r-2' : '' }}">
            ...
            <li class="transition hover:bg-base-200 border-primary rounded-sm group {{ request()->is('perawatan*') ? 'bg-base-300 border-r-2' : '' }}">
            ...
            <li class="transition hover:bg-base-200 border-primary rounded-sm group {{ request()->is('pengguna*') ? 'bg-base-300 border-r-2' : '' }}">
