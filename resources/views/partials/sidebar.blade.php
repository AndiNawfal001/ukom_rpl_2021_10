<div class="relative flex-1 flex flex-col min-h-0 shadow bg-base-100 pt-0">
    <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
       <div class="flex-1 px-3 divide-y space-y-1">
        <ul class="space-y-2">
            <li class="transition hover:bg-base-200 rounded-lg group {{ request()->is('dashboard') ? 'bg-base-300 rounded-lg' : '' }}">
                <a href="/dashboard" class="flex items-center p-2 ">
                    <svg class="w-6 h-6 text-gray-500 group-hover:text-base-content {{ request()->is('dashboard') ? 'text-base-content' : '' }}" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            @can('admin+manajemen')
                <li class="transition hover:bg-base-200 rounded-lg group {{ request()->is('barangMasuk*') ? 'bg-base-300 rounded-lg' : '' }}">
                    <a href="/barangMasuk" class="flex items-center p-2">
                        <svg class="w-6 h-6 text-gray-500 group-hover:text-base-content {{ request()->is('barangMasuk*') ? 'text-base-content' : '' }}" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <li class="transition group">
                ...
                <ul class="py-2 space-y-2 dropdown-container {{ request()->is('approval/BB*', 'approval/PB*' ,'approval/pemutihan*') ? 'block' : 'hidden' }}">
                    <li>
                        <a href="/approval/BB" class="flex items-center p-2 pl-11 w-full text-base font-normal rounded-lg transition duration-75 group hover:bg-base-200 {{ request()->is('approval/BB*') ? 'bg-base-300 rounded-lg' : '' }}">Barang Baru</a>
                    </li>
                    <li>
                        <a href="/approval/PB" class="flex items-center p-2 pl-11 w-full text-base font-normal rounded-lg transition duration-75 group hover:bg-base-200 {{ request()->is('approval/PB*') ? 'bg-base-300 rounded-lg' : '' }}">Perbaikan</a>
                    </li>
                    <li>
                        <a href="/approval/pemutihan" class="flex items-center p-2 pl-11 w-full text-base font-normal rounded-lg transition duration-75 group hover:bg-base-200 {{ request()->is('approval/pemutihan*') ? 'bg-base-300 rounded-lg' : '' }}">Pemutihan</a>
                    </li>
            ...
            <li class="transition group">
                ...
                <ul class="py-2 space-y-2 dropdown-container {{ request()->is('pengajuan/BB*', 'pengajuan/PB*' ,'pemutihan*') ? 'block' : 'hidden' }}">
                    <li>
                        <a href="/pengajuan/BB" class="flex items-center p-2 pl-11 w-full text-base font-normal rounded-lg transition duration-75 group hover:bg-base-200 {{ request()->is('pengajuan/BB*') ? 'bg-base-300 rounded-lg' : '' }}">Barang Baru</a>
                    </li>
                    <li>
                        <a href="/pengajuan/PB" class="flex items-center p-2 pl-11 w-full text-base font-normal rounded-lg transition duration-75 group hover:bg-base-200 {{ request()->is('pengajuan/PB*') ? 'bg-base-300 rounded-lg' : '' }}">Perbaikan</a>
                    </li>
                    <li>
                        <a href="/pemutihan" class="flex items-center p-2 pl-11 w-full text-base font-normal rounded-lg transition duration-75 group hover:bg-base-200 {{ request()->is('pemutihan*') ? 'bg-base-300 rounded-lg' : '' }}">Pemutihan</a>
                    </li>
                </ul>
            </li>

            <li class="transition hover:bg-base-200 rounded-lg group {{ request()->is('barang', 'barang/detail*') ? 'bg-base-300 rounded-lg' : '' }}">
                <a href="/barang" class="flex items-center p-2">
                    <svg class="w-6 h-6 text-gray-500 group-hover:text-base-content {{ request()->is('barang', 'barang/detail*') ? 'text-base-content' : '' }}" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <li class="transition hover:bg-base-200 rounded-lg group {{ request()->is('perawatan*') ? 'bg-base-300 rounded-lg' : '' }}">
                <a href="/perawatan" class="flex items-center p-2">
                    <svg class="w-6 h-6 text-gray-500 group-hover:text-base-content {{ request()->is('perawatan*') ? 'text-base-content' : '' }}" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <li class="transition hover:bg-base-200 rounded-lg group {{ request()->is('pengguna*') ? 'bg-base-300 rounded-lg' : '' }}">
                <a href="/pengguna" class="flex items-center p-2">
                    <svg class="w-6 h-6 text-gray-500 group-hover:text-base-content {{ request()->is('pengguna*') ? 'text-base-content' : '' }}" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <li class="transition hover:bg-base-200 rounded-lg group {{ request()->is('supplier*') ? 'bg-base-300 rounded-lg' : '' }}">
