        ...
        <div class="hero-content w-full flex-col lg:flex-row-reverse gap-7"  data-aos="zoom-in" duration="2000">
            <div class="card flex-shrink-0 w-full max-w-sm shadow-lg bg-base-200">
                ...
                <form action="login" method="POST">
                    ...
                    <input type="email" name="email" id="email" placeholder="email" class="input input-sm input-bordered @error('email') @enderror"  autofocus required value="{{ old ('email') }}" autocomplete="off"/>
                    ...
                    <input type="password" name="password" placeholder="password" class="input input-sm input-bordered" required/>
                    </div>
