 ...
 <div class="shadow-md rounded-md mx-auto  bg-base-100 p-5">
    <form action="editsimpan" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex justify-between">
            <h2 class="h1-judul">Form Edit Pengguna</h2>
            <div >
        ...
        <div class="lg:flex gap-10">
            ...
            <div class="basis-1/2">
                <div class="form-control">
                    ...
                    <input type="text" name="username" class="input input-sm input-bordered"
                ...
                <div class="form-control">
                    ...
                    <input type="email" name="email" class="input input-sm input-bordered"
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="nama" class="input input-sm input-bordered"
                ...
                <div class="form-control">
                    ...
                    <input type="text" name="kontak" class="input input-sm input-bordered"
